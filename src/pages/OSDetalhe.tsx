  ...
  const handleSharePDF = async () => {
    try {
      ...
      if (navigator.canShare && navigator.canShare({ files: [file] })) {
        ...
        toast.dismiss('shareToast');
        toast.error("O seu aparelho ou navegador não suporta envio direto. Use o botão branco para baixar.");
      }
    } catch (err) {
      toast.dismiss('shareToast');
      toast.error("Ocorreu um erro ao preparar o documento para envio.");
    }
  };
